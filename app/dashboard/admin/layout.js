    ...
    if (checking) {
        return (
            <div style={{
                ...
                <p style={{ color: '#4b636c' }}>Checking admin access...</p>
            </div>
        );
    }
    ...
    if (!hasAccess) {
        return (
            <div style={{
                ...
                <p style={{ color: '#4b636c', marginBottom: '1rem' }}>
                ...
                <div className="p-6 border-t border-[#dce3e5]/20 dark:border-[#2d3b41]/20 bg-white/5 dark:bg-black/5">
                    <div className="flex flex-col gap-2">
                        <button
                            ...
                            className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 transition-colors cursor-pointer group"
                        >
                            <span className="material-symbols-outlined text-[24px]">logout</span>
                            <p className="text-sm font-black uppercase tracking-widest">Logout</p>
                        </button>

                        <div className="mt-2 p-4 bg-white/70 dark:bg-[#182125]/70 backdrop-blur-md rounded-xl border border-primary/20">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <p className="text-sm font-black text-[#111618] dark:text-white truncate uppercase tracking-tighter">Admin User</p>
                                    <p className="text-[10px] text-[#4b636c] dark:text-gray-400 font-black uppercase tracking-tighter">Super Admin</p>
                                </div>
                            </div>
                        </div>
                    </div>
