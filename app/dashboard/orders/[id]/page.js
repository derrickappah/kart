    ...
    return (
      <div className="min-h-screen bg-[#f6f7f8] dark:bg-[#0d1517] flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link
          ...
          className="px-6 py-3 bg-white dark:bg-[#1e292b] border border-slate-200 dark:border-slate-700 rounded-2xl font-bold text-slate-700 dark:text-white hover:bg-slate-50 dark:hover:bg-white/5 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-primary"
        >
          ← Back to Orders
        </Link>
      </div>
      ...
      <div className="max-w-md md:max-w-5xl mx-auto min-h-screen flex flex-col relative px-4 md:px-6">
        ...
        <header className="sticky top-0 z-50 flex items-center gap-3 py-4 bg-[#f0f2f5]/90 dark:bg-[#0d1517]/90 backdrop-blur-xl border-b border-black/5 dark:border-white/5 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-lg md:text-xl font-bold leading-none">Order Details</h1>
            <p className="text-[11px] text-slate-400 font-mono font-bold tracking-widest mt-1 uppercase">
              #{order.id.slice(0, 8)}
            </p>
          </div>
        </header>
        ...
        <main className="flex-1 pb-32">
          ...
          {order.refund_status === 'Requested' && (
            <div className="mb-4 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 p-4 rounded-2xl flex gap-3" role="status">
          ...
          {order.refund_status === 'Refunded' && (
            <div className="mb-4 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 p-4 rounded-2xl flex gap-3" role="status">
          ...
          {order.refund_status === 'Rejected' && (
            <div className="mb-4 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-4 rounded-2xl flex gap-3" role="status">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
            ...
            {/* Left Column: Order Status, Actions, & Timeline */}
            <div className="md:col-span-7 space-y-6">
              ...
              >
                ...
                <DynamicLucideIcon
                  ...
                  aria-hidden="true"
                  className="absolute -right-4 -top-4 text-[120px] opacity-[0.06] pointer-events-none"
                  ...
                  <div className="mt-5 pt-4 border-t border-black/5 dark:border-white/5">
                    <ol className="flex items-center justify-between" aria-label="Order progress">
                      {STEPS.map((step, i) => {
                        ...
                        return (
                          <li key={step} className="flex-1 flex flex-col items-center gap-1.5" aria-current={isActive ? 'step' : undefined}>
                            <div className="relative w-full flex items-center">
                              {i > 0 && (
                                <div className="absolute right-1/2 w-full h-[2px] -translate-y-0">
                                  <div
                                    className={`h-full ${currentStep >= cfg.step ? '' : 'bg-slate-200 dark:bg-slate-700'}`}
              ...
              {statusHistory && statusHistory.length > 0 && (
                <section className="bg-white dark:bg-[#1a2325] rounded-3xl p-5 border border-black/5 dark:border-white/5 shadow-sm">
                  ...
                  <ol className="space-y-1" aria-label="Timeline history">
            ...
            {/* Right Column: Product Card, Price Breakdown, Counterparty Details */}
              ...
              <section className="bg-white dark:bg-[#1a2325] rounded-3xl overflow-hidden border border-black/5 dark:border-white/5 shadow-sm">
                ...
                {order.product?.id && (
                  <Link
                    ...
                    className="flex items-center justify-between px-4 py-3 border-t border-black/5 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/3 transition-colors focus-visible:ring-2 focus-visible:ring-primary"
                  >
                ...
                <div className="flex items-center gap-3">
                  ...
                  {counterparty?.id && (
                    <Link
                      ...
                      className="size-9 rounded-xl bg-slate-50 dark:bg-white/5 border border-black/5 dark:border-white/8 flex items-center justify-center hover:bg-slate-100 dark:hover:bg-white/10 transition-colors shrink-0 focus-visible:ring-2 focus-visible:ring-primary"
                    >
