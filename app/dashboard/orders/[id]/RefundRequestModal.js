...
export default function RefundRequestModal({ orderId, isOpen, onClose, onSuccess }) {
  ...
  return (
    ...
    >
      ...
      {/* Dialog Body */}
      <div className="relative bg-white dark:bg-[#1a2325] w-full max-w-md rounded-[32px] border border-black/5 dark:border-white/5 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
