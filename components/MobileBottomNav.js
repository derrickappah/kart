...
export default function MobileBottomNav({ user }) {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 flex w-full justify-center border-t border-gray-100 bg-white/95 pb-2 pt-1 backdrop-blur-lg dark:border-gray-800 dark:bg-[#242428]/95">
